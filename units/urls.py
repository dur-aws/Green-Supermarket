...
from .views import UnitOfMeasureListView, UnitOfMeasureCreateView, UnitOfMeasureUpdateView, UnitOfMeasureSearchView, UnitOfMeasureToggleStatusView
...
urlpatterns = [
    ...
    path('<int:pk>/status/',UnitOfMeasureToggleStatusView.as_view(), name='uom_status'),
]